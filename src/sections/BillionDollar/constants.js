...
export const mockBillionIdea = {
  ...
  text: (
    <p className="text text-colored">
      ...
      grow at an even faster pace and removes the inefficiencies and challenges
      cannabis businesses face.
      <br />
      <br />
      Budding Technologies, Inc., with its streamlined cannabis marketplace and
      blockchain technologies offers a{' '}
      <span className="text-body fw-bold">
        unified solution for cannabis businesses and users to transact safely,
...
export const mockBillionSolution = {
  title: (
    <h2>
      A 300 Billion Dollar Problem Meets a
